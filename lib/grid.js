(function () {
  ...
  Grid.prototype.inBounds = function(pos) {
    return (pos[0] > -1 && pos[0] < Mario.Constants.NUM_SQUARES_WIDE &&
            pos[1] > -1 && pos[1] < Mario.Constants.NUM_SQUARES_TALL);
  };
  ...
  Grid.prototype.furthestColorInARow = function(start, direction) {
    ...
    return [pos[0]-directions[0], pos[1]-directions[1]];
  };
  ...
  Grid.prototype.findObjectsToDestroy = function(start) {
    ...
    var vStart = furthestColorInARow(directions.up);
    var vEnd = furthestColorInARow(directions.down);
    var hStart = furthestColorInARow(directions.left);
    var hEnd = furthestColorInARow(directions.right);
    var i;
    var vertical = [];
    var horizontal = [];
