(function () {
    ...
    if (deltaY || currentPill.gridPos[1] === 0) {
      ...
      objects.forEach(function(object) {
        if (that.pillLandedOn(object)) {
          that.gameOver = that.pillOverlaps(currentPill, object);
  ...
  Game.prototype.draw = function (ctx) {
    var message;
    if (this.gameState.over || this.gameState.paused) {
      message = (this.gameOver ? "Game Over" : "Pause");
      this.setMessageStyle(ctx, 32);
