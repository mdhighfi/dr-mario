(function () {
  ...
  Game.prototype.step = function () {
    debugger;
    if (this.grid.squares[3,0] !== Mario.Constants.EMPTY ||
        this.grid.squares[4,0] !== Mario.Constants.EMPTY
      ) {
        return true;
    }
    ...
    if (deltaY || currentPill.gridPos[1] === 0) {
      ...
      objects.forEach(function(object) {
        // debugger;
        // if (that.pillOverlaps(currentPill, object) && object !== currentPill) {
        //   overlap = true;
        // }
